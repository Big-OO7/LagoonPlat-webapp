        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex justify-between items-start">
            <div className="flex-1">
              ...
              {/* Display labeler comment if present */}
              {submission.labeler_comment && (
                <div className="mt-3 p-3 bg-yellow-50 border-2 border-yellow-300 rounded">
                  ...
                  <p className="text-sm text-yellow-800 mt-2 whitespace-pre-wrap">{submission.labeler_comment}</p>
                </div>
              )}
